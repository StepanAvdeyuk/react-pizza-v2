...
import { decCartItem, addCartItem, removeCartItem } from '../redux/slices/cartSlice'
...
const CartItem: React.FC<CartItemProps> = ({name, price, count, imageUrl, size, type, id}) => {
    ...
    const incItem = () => {
        dispatch(addCartItem({id} as CartItemType))
    }
    ...
    <div className="cart__item">
        <div className="cart__item-img">
            ...
            <div className="cart__item-info">
                <h3>{name}</h3>
                <p>{pizzaType[type]}, {size} см.</p>
            </div>
            <div className="cart__item-count">
                <button onClick={decItem} className="button button--outline button--circle cart__item-count-minus">
